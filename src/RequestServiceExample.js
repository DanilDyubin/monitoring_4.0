...
//         BASE_BACKEND_URL + '/oauth/sudir?login=admin&password=adminadmin1'
//       );
...
//     return fetch(BASE_BACKEND_URL + '/services/' + serviceCode).then((res) =>
//       res.json()
//     );
//   }
...
//     return fetch(BASE_BACKEND_URL + '/object/' + uin).then((res) => res.json());
//   }
